...
public class Calculation {
	...
	public static double FloorArea(double flrWidth, double flrDepth) {
	...
	public static double PaintRequired(double wallWidth, double wallHeight, double wndWidth, double wndHeight, int amountOfWalls, int amountOfDoors, int amountOfWindows) {
		// Initial Areas
	...
	public static double roomVolume(double roomWidth, double roomHeight, double roomDepth) {
